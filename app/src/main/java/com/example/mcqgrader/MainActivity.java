...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoadKey.setOnClickListener(v -> {
            ...
            Intent chooserIntent = Intent.createChooser(intent, "Select Answer Key...");
    ...
    private void loadJsonFromUri(Uri uri) {
        try (InputStream is = getContentResolver().openInputStream(uri);
            ...
            btnExportAnswers.setVisibility(View.GONE);
            btnClearKey.setVisibility(View.VISIBLE); // Show the clear button
            lastExportJson = null;
